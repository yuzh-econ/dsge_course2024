...
estimation(datafile=us_data,mode_compute=4,first_obs=143,presample=4,
           prefilter=0,mh_replic=10000,mh_nblocks=2,mh_jscale=0.40,mh_drop=0.2,mode_file=NKlinear_Est_All_mode, mode_check );
% 
%
%estimation(datafile=us_data,mode_compute=4,first_obs=143,presample=4,
%           prefilter=0,mh_replic=50000,mh_nblocks=2,mh_jscale=0.40,mh_drop=0.2, mode_file=NKlinear_Est_Indexing_saved_mode, mode_check );
%
