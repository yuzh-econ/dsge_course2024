...
//Linear version
//Model with only  Indexing and no Habit
//
...
estimation(datafile=us_data,mode_compute=4,first_obs=143,presample=4,
           prefilter=0,mh_replic=10000,mh_nblocks=2,mh_jscale=0.40,mh_drop=0.2,endogenous_prior,mode_file=NKlinear_Est_Indexing_mode, mode_check);
% 
%
%estimation(datafile=us_data,mode_compute=0,first_obs=143,presample=4,
%           prefilter=0,mh_replic=100000,mh_nblocks=2,mh_jscale=0.40,mh_drop=0.2,mode_file=NKlinear_Est_Indexing_End_Priors, mode_check );
%
