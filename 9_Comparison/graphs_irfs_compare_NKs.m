...
RESULT_names={'NKlinear_Est_All_results','NKlinear_Est_Habit_results', 'NKlinear_Est_Indexing_results' , 'NKlinear_Est_None_results'}; %%EXACT NAMES OF THE RESULTS FILES TO LOAD
lin_vs_nonlin=[1,1,1,1]; %=0 IF THE CORRESPONDING MODEL IN RESULT_NAMES IS NON-LINEAR, 1 IF IT IS LINEAR
...
names = char('dyobs', 'pinfobs', 'robs', 'Output', 'Consumpton', 'Investment', 'Inflation', 'Nominal Iterest Rate'); % NAMES OF THE EDOGENOUS VARIABLES FOR THE GRAPHS. YOU CAN SPECIFY ANY NAME YOU WANT BUT NEED TO HAVE THE SAME NUMBER OF ELEMENT OF VAR_IRFs


%Model_names=char( 'NK (non-linear)', 'NK (linear)' ); %NAMES OF THE MODEL VARIANTS TO APPEAR IN THE LEGEND OF THE GRAPHS
Model_names=char( 'NK (All) ', 'NK (Habit)', 'NK (Indexing)', 'NK (None)'); %NAMES OF THE MODEL VARIANTS TO APPEAR IN THE LEGEND OF THE GRAPHS

Rows_figure=4; % NUMBER OF ROWS IN EACH PLOT
Column_figure=2; % NUMBER OF COLUMNSS IN EACH PLOT
...
NUM_VAR=length(VAR_IRFs_linear);%%NUMBER OF VARIABLES TO COMPARE
