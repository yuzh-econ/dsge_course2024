...
//Linear version
//Model with No  Indexing Nor Habit
//
...
estimation(datafile=us_data,mode_compute=4,first_obs=143,presample=4,
           prefilter=0,mh_replic=10000,mh_nblocks=2,mh_jscale=0.40,mh_drop=0.2,endogenous_prior, mode_file=NKlinear_Est_None_saved_mode, mode_check);
% 
%
%estimation(datafile=us_data,mode_compute=4,first_obs=143,presample=4,
%           prefilter=0,mh_replic=10000,mh_nblocks=2,mh_jscale=0.40,mh_drop=0.2,mode_file=NKlinear_Est_None_End_Priors_saved_mode, mode_check );
%
