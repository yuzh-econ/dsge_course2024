...
RESULT_names={'NKlinear_results_h00i00','NKlinear_results_h07i00', 'NKlinear_results_h99i00'}; %%EXACT NAMES OF THE RESULTS FILES TO LOAD
...
FIGTITLE_NAME_SHOCKS = {'Habit TFP', 'Habit G', 'Habit M', 'Habit MS'};
...
Model_names=char( 'low (0.0) Habit', 'medium (0.7)', 'high (0.99)' ); %NAMES OF THE MODEL VARIANTS TO APPEAR IN THE LEGEND OF THE GRAPHS
