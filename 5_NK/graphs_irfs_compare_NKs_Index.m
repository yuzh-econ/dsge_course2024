...
RESULT_names={'NKlinear_results_h00i00','NKlinear_results_h00i05', 'NKlinear_results_h00i99'}; %%EXACT NAMES OF THE RESULTS FILES TO LOAD
...
FIGTITLE_NAME_SHOCKS = {'Index TFP', 'Index G', 'Index M', 'Index MS'};
...
Model_names=char( 'low (0.0) Index', 'medium (0.5)', 'high (0.99)' ); %NAMES OF THE MODEL VARIANTS TO APPEAR IN THE LEGEND OF THE GRAPHS
