...
RESULT_names={'NKRBC_adj01','NKRBC_adj20', 'NKRBC_adj40'}; %%EXACT NAMES OF THE RESULTS FILES TO LOAD
...
FIGTITLE_NAME_SHOCKS = {'RBC TFP', 'RBC G', 'RBC M', 'RBC MS'};
...
Model_names=char( 'RBC - Low (0.1) Adj', 'medium (2.0)', 'high (4.0)' ); %NAMES OF THE MODEL VARIANTS TO APPEAR IN THE LEGEND OF THE GRAPHS
