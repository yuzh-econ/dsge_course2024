...
RESULT_names={'RBC/Output/RBC_results', 'RBC_hab/Output/RBC_hab_results' }; %%EXACT NAMES OF THE RESULTS FILES TO LOAD
...
Model_names=char( '\chi=0.0 (baseline)', '\chi=0.5'); %NAMES OF THE MODEL VARIANTS TO APPEAR IN THE LEGEND OF THE GRAPHS
