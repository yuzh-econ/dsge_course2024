...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
var  V U C H K S X I IS Sdash lambda Wh rK adash RPS LAMBDA R Q u au Rn PIE PIEw 
...
stoch_simul(order=2,pruning, irf=40)  Y C I H Hd W R Q Rn MC PIE PIEw u V Deltap  Deltaw ;
