...
RESULT_names={'RBC_hab/Output/RBC_hab_results_05noadj', 'RBClinear_hab/Output/RBClinear_hab_results_05', }; %%EXACT NAMES OF THE RESULTS FILES TO LOAD
...
Model_names=char( 'non-linear, \chi=0.50', 'linear' ); %NAMES OF THE MODEL VARIANTS TO APPEAR IN THE LEGEND OF THE GRAPHS
