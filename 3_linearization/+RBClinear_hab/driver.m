...
M_.param_names(15) = {'chii'};
M_.param_names_tex(15) = {'{\chi}'};
M_.param_names_long(15) = {'Habitat parameter'};
...
cy = M_.params(6);
M_.params(9) = M_.params(2)*(1-M_.params(1))/(M_.params(2)*(1-M_.params(1))+M_.params(1)*M_.params(6)*(1-M_.params(15)));
H_bar = M_.params(9);
%
% SHOCKS instructions
%
...
save([M_.dname filesep 'Output' filesep 'RBClinear_hab_results.mat'], 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'RBClinear_hab_results.mat'], 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'RBClinear_hab_results.mat'], 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'RBClinear_hab_results.mat'], 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'RBClinear_hab_results.mat'], 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'RBClinear_hab_results.mat'], 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'RBClinear_hab_results.mat'], 'oo_recursive_', '-append');
end
if ~isempty(lastwarn)
