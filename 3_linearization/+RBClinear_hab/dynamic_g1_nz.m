...
% Returns the coordinates of non-zero elements in the Jacobian, in column-major order, for each lead/lag (only for endogenous)
  ...
  nzij_pred(1,1)=5; nzij_pred(1,2)=7;
  nzij_pred(2,1)=9; nzij_pred(2,2)=7;
  nzij_pred(3,1)=1; nzij_pred(3,2)=9;
  nzij_pred(4,1)=10; nzij_pred(4,2)=10;
  nzij_pred(5,1)=11; nzij_pred(5,2)=11;
  ...
  nzij_current(8,1)=6; nzij_current(8,2)=3;
  ...
  nzij_current(19,1)=9; nzij_current(19,2)=7;
  ...
  nzij_current(25,1)=5; nzij_current(25,2)=10;
  ...
  nzij_fwrd(2,1)=6; nzij_fwrd(2,2)=6;
end
