...
RESULT_names={'RBC_basic/Output/RBC_basic_results', 'RBC_hab/Output/RBC_hab_results_00noadj', 'RBClinear_basic/Output/RBClinear_basic_results'}; %%EXACT NAMES OF THE RESULTS FILES TO LOAD
lin_vs_nonlin=[1,0,1]; %=0 IF THE CORRESPONDING MODEL IN RESULT_NAMES IS NON-LINEAR, 1 IF IT IS LINEAR


VAR_IRFs_nonlin = {'YY','CC','II','HH','WW','RR'}; %% NAMES OF ENDOGENOUS VARIABLES OF INTEREST FOR THE IRFS (NON-LINEAR MODELS) - NEED TO HAVE EXACTLY SAME NAME AS IN THE .MOD FILE

VAR_IRFs_linear= {'y','c','i','h','w','r'};
NAME_SHOCKS={'_epsA','_epsG'};%% NAMES OF EXOGENOUS SHOCKS OF INTEREST FOR THE IRFS - NEED TO HAVE EXACTLY SAME NAME AS IN THE .MOD FILE
names = char('Output', 'Consumption', 'Investment', 'Hours worked', 'Real wage', 'Real interest rate'); % NAMES OF THE EDOGENOUS VARIABLES FOR THE GRAPHS. YOU CAN SPECIFY ANY NAME YOU WANT BUT NEED TO HAVE THE SAME NUMBER OF ELEMENT OF VAR_IRFs


%Model_names=char( '\theta=0', '\theta=0.5', '\theta=1.5' ); %NAMES OF THE MODEL VARIANTS TO APPEAR IN THE LEGEND OF THE GRAPHS
Model_names=char( 'RBCbasic', 'Hab0', 'RBClinear'); %NAMES OF THE MODEL VARIANTS TO APPEAR IN THE LEGEND OF THE GRAPHS


Rows_figure=2; % NUMBER OF ROWS IN EACH PLOT
