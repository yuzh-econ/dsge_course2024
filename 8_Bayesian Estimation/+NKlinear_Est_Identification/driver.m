...
options_ = [];
M_.fname = 'NKlinear_Est_Identification';
...
M_.endo_names(33) = {'robs'};
M_.endo_names_tex(33) = {'robs'};
M_.endo_names_long(33) = {'robs'};
M_.endo_names(34) = {'dy'};
M_.endo_names_tex(34) = {'dy'};
M_.endo_names_long(34) = {'dy'};
M_.endo_names(35) = {'pinfobs'};
M_.endo_names_tex(35) = {'pinfobs'};
M_.endo_names_long(35) = {'pinfobs'};
...
M_.param_names(23) = {'trend'};
M_.param_names_tex(23) = {'trend'};
M_.param_names_long(23) = {'trend'};
M_.param_names(24) = {'conspie'};
M_.param_names_tex(24) = {'conspie'};
M_.param_names_long(24) = {'conspie'};
M_.param_names(25) = {'PIEss'};
M_.param_names_tex(25) = {'PIEss'};
M_.param_names_long(25) = {'PIEss'};
...
M_.mapping.Y.eqidx = [18 21 28 34 ];
...
M_.mapping.PIE.eqidx = [27 28 29 35 ];
M_.mapping.MC.eqidx = [20 23 27 ];
M_.mapping.Rn.eqidx = [28 29 33 ];
...
M_.mapping.YF.eqidx = [5 6 7 9 28 ];
...
M_.mapping.robs.eqidx = [33 ];
M_.mapping.dy.eqidx = [34 ];
M_.mapping.pinfobs.eqidx = [35 ];
...
M_.params(25) = 1.005;
PIEss = M_.params(25);
M_.params(26) = (1.0*M_.params(25)/M_.params(5)-1)*100;
consr = M_.params(26);
M_.params(24) = M_.params(25);
conspie = M_.params(24);
M_.params(19) = 0.4;
hss = M_.params(19);
...
oo_.steady_state(34) = M_.params(23);
oo_.steady_state(33) = M_.params(26);
oo_.steady_state(35) = M_.params(24);
if M_.exo_nbr > 0
...
estim_params_.var_exo = [estim_params_.var_exo; 2, NaN, (-Inf), Inf, 4, 0.50, 2.00, NaN, NaN, NaN ];
...
estim_params_.param_vals = [estim_params_.param_vals; 15, NaN, (-Inf), Inf, 1, 0.50, 0.15, NaN, NaN, NaN ];
...
estim_params_.param_vals = [estim_params_.param_vals; 24, NaN, (-Inf), Inf, 2, 0.625, 0.10, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 23, NaN, (-Inf), Inf, 3, 0.40, 0.10, NaN, NaN, NaN ];
...
save([M_.dname filesep 'Output' filesep 'NKlinear_Est_Identification_results.mat'], 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'NKlinear_Est_Identification_results.mat'], 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'NKlinear_Est_Identification_results.mat'], 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'NKlinear_Est_Identification_results.mat'], 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'NKlinear_Est_Identification_results.mat'], 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'NKlinear_Est_Identification_results.mat'], 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'NKlinear_Est_Identification_results.mat'], 'oo_recursive_', '-append');
end
if ~isempty(lastwarn)
