...
if T_flag
    T = NKlinear_Est2.dynamic_resid_tt(T, y, x, params, steady_state, it_);
end
residual = zeros(36, 1);
lhs = y(32);
...
rhs = 1/params(22)*y(56)+y(11)+y(43)*1/(2*params(12));
residual(11) = lhs - rhs;
lhs = y(41);
rhs = y(34)+y(37)+y(44);
residual(12) = lhs - rhs;
...
rhs = 1/params(20)*y(52)+y(3)+1/(2*params(12))*y(28);
residual(25) = lhs - rhs;
lhs = y(26);
rhs = y(17)+y(18)+y(23);
residual(26) = lhs - rhs;
lhs = y(29);
rhs = params(5)/(1+params(5)*params(15))*y(54)+params(15)/(1+params(5)*params(15))*y(7)+(1-params(5)*params(13))*(1-params(13))/((1+params(5)*params(15))*params(13))*(y(30)+y(45));
residual(27) = lhs - rhs;
lhs = y(31);
