...
M_.endo_names(36) = {'dc'};
M_.endo_names_tex(36) = {'dc'};
M_.endo_names_long(36) = {'dc'};
...
M_.param_names(27) = {'ctrend'};
M_.param_names_tex(27) = {'ctrend'};
M_.param_names_long(27) = {'ctrend'};
...
options_.varobs(4)  = {'dc'};
options_.varobs_id = [ 33 34 35 36  ];
M_ = setup_solvers(M_);
...
M_.mapping.C.eqidx = [14 16 21 36 ];
...
estim_params_.param_vals = [estim_params_.param_vals; 27, NaN, (-Inf), Inf, 5, 0.30, 0.10, NaN, NaN, NaN ];
...
options_.mode_file = 'NKlinear_Est_compute_6_mode';
...
save([M_.dname filesep 'Output' filesep 'NKlinear_Est2_results.mat'], 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'NKlinear_Est2_results.mat'], 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'NKlinear_Est2_results.mat'], 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'NKlinear_Est2_results.mat'], 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'NKlinear_Est2_results.mat'], 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'NKlinear_Est2_results.mat'], 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'NKlinear_Est2_results.mat'], 'oo_recursive_', '-append');
end
if ~isempty(lastwarn)
