...
//
//Ony Identification prior to Estimation
//
//////////////////////////////////////////////////////////////////////////////////////////////////
...
chi gammap rho_r theta_pie theta_y hss Rss hfss Rfss ;

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%ADD OBSERVATION TRENDS%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
parameters trend conspie PIEss consr;
...
conspie   = PIEss; // quarterly ss inflation rate
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
stderr epsG,     INV_GAMMA_PDF,0.50, 2.00; //government spending - rescaled stderr/gy
