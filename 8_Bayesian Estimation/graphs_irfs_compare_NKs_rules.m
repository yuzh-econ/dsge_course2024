...
RESULT_names={'NKlinear_Est/Output/NKlinear_Est_resultsIMP','NKlinear_Est/Output/NKlinear_Est_resultsTAY'}; %%EXACT NAMES OF THE RESULTS FILES TO LOAD
...
Model_names=char( 'Implementable', 'Taylor Rule'); %NAMES OF THE MODEL VARIANTS TO APPEAR IN THE LEGEND OF THE GRAPHS
