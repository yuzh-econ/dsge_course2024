...
RESULT_names={'NKlinear_policy_results_Ramsey','NKlinear_policy_results_Discrete','NKlinear_policy_results_Simple'}; %%EXACT NAMES OF THE RESULTS FILES TO LOAD
lin_vs_nonlin=[1,1,1]; %=0 IF THE CORRESPONDING MODEL IN RESULT_NAMES IS NON-LINEAR, 1 IF IT IS LINEAR

%RESULT_names={'NKlinear_policy_opt_results','NKlinear_policy_tct_results','NKlinear_policy_sim_results' }; %%EXACT NAMES OF THE RESULTS FILES TO LOAD
%lin_vs_nonlin=[1,1,1]; %=0 IF THE CORRESPONDING MODEL IN RESULT_NAMES IS NON-LINEAR, 1 IF IT IS LINEAR


VAR_IRFs_nonlin = {'YY','CC','II','HH','WW','RR','RnRn','QQ','PIEPIE'}; %% NAMES OF ENDOGENOUS VARIABLES OF INTEREST FOR THE IRFS (NON-LINEAR MODELS) - NEED TO HAVE EXACTLY SAME NAME AS IN THE .MOD FILE

VAR_IRFs_linear= {'Y','C','I','H','W','R','Rn','Q','PIE'};
NAME_SHOCKS={'_epsA','_epsG','_epsMS'};%% NAMES OF EXOGENOUS SHOCKS OF INTEREST FOR THE IRFS - NEED TO HAVE EXACTLY SAME NAME AS IN THE .MOD FILE
names = char('Output', 'Consumption', 'Investment', 'Hours worked', 'Real wage', 'Real interest rate', 'Nominal interest rate', 'Tobin Q', 'Inflation'); % NAMES OF THE EDOGENOUS VARIABLES FOR THE GRAPHS. YOU CAN SPECIFY ANY NAME YOU WANT BUT NEED TO HAVE THE SAME NUMBER OF ELEMENT OF VAR_IRFs


%Model_names=char( 'NK (non-linear)', 'NK (linear)' ); %NAMES OF THE MODEL VARIANTS TO APPEAR IN THE LEGEND OF THE GRAPHS
Model_names=char( 'Ramsey', 'Discretion', 'Simple'); %NAMES OF THE MODEL VARIANTS TO APPEAR IN THE LEGEND OF THE GRAPHS
...
color = {'-k','--r','.-g','+b','*y', '-m'};%color and line style for the plots
