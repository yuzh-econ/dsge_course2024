...
RESULT_names={'NKlinear_results','NK_results' }; %%EXACT NAMES OF THE RESULTS FILES TO LOAD
lin_vs_nonlin=[1,0]; %=0 IF THE CORRESPONDING MODEL IN RESULT_NAMES IS NON-LINEAR, 1 IF IT IS LINEAR
...
Model_names=char( 'NK (linear)', 'NK (non-linear)' ); %NAMES OF THE MODEL VARIANTS TO APPEAR IN THE LEGEND OF THE GRAPHS
